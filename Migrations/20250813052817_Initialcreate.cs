        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AircraftMaintenanceMaintenanceId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CrewMembers", x => x.CrewId);
                    table.ForeignKey(
                        name: "FK_CrewMembers_AircraftMaintenances_AircraftMaintenanceMaintenanceId",
                        column: x => x.AircraftMaintenanceMaintenanceId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RouteId = table.Column<int>(type: "int", nullable: false),
                    AircraftId = table.Column<int>(type: "int", nullable: false),
                    DepartureDate = table.Column<DateTime>(type: "datetime2", nullable: false, computedColumnSql: "CAST([DepartureUtc] AS date)")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CrewMembers_AircraftMaintenanceMaintenanceId",
                table: "CrewMembers",
                column: "AircraftMaintenanceMaintenanceId");
